...
class UserService extends BaseService
{
    ...
    public function getLowerThanRole(Forms\IndexForm $form): LengthAwarePaginator|null
    {
        ...
        $result = $repository->paginate($form->page, $this->limit);

        return is_null($result->items) ? null : $this->paginator($result->items, $result->total, $this->limit, $form->page);
    }
