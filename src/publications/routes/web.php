...
if (config("mycustom.required_login")) {
...
Route::get('/password_reset/{token}/{email}', [Controller\Auth\PasswordForgotController::class, 'passwordResetForm'])->name('passwordResetForm');
